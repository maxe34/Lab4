...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        var str = _inputString.Substring(_sBoxNumber, 6);

        var strToInt2 =Convert.ToInt32(str.Substring(0,1),2);
        var strToInt3 =Convert.ToInt32(str.Substring(5,1),2);

        int value = sBox[_sBoxNumber, strToInt2, strToInt3];
        string binary = Convert.ToString(value, 2);
        
        Console.WriteLine(value+" value");
        Console.WriteLine(binary+" bynary");
